      ...
      schemas: {
        Student: {
          ...
          properties: {
            ...
            hinh_anh:       { type: 'string',  example: 'uploads/students/1234.jpg', nullable: true },
            ngay_sinh:      { type: 'string',  example: '2016-05-20', nullable: true },
            gioi_tinh:      { type: 'string',  enum: ['nam', 'nu', 'khac'], nullable: true },
            dia_chi:        { type: 'string',  example: '123 Lê Lợi, Quảng Ngãi', nullable: true },
            ten_phu_huynh:  { type: 'string',  example: 'Nguyễn Văn Bình', nullable: true },
            sdt_phu_huynh:  { type: 'string',  example: '0905123456', nullable: true },
            ghi_chu:        { type: 'string',  nullable: true },
            trang_thai:     { type: 'string',  enum: ['dang_hoc', 'nghi_hoc'], default: 'dang_hoc' },
            ngay_nhap_hoc:  { type: 'string',  example: '2024-09-01' },
            ten_lop_hoc:    { type: 'string',  example: 'Lớp 3, Luyện chữ đẹp', nullable: true },
          },
        },
        Teacher: {
          type: 'object',
        ...
        ClassGroup: {
          ...
          properties: {
            ...
            lich_hoc:       { type: 'string',  example: 'Thứ 2, 4, 6 — 17:00-18:30', nullable: true },
        ...
        AttendanceRecord: {
          ...
          properties: {
            ...
            trang_thai:   { type: 'string',  enum: ['co_mat', 'vang_mat', 'vang_phep'], default: 'co_mat' },
            ghi_chu:      { type: 'string',  nullable: true },
          },
        },
        Finance: {
        ...
        Result: {
          ...
          properties: {
            ...
            xep_loai:   { type: 'string',  enum: ['gioi', 'kha', 'trung_binh', 'yeu'], nullable: true },
